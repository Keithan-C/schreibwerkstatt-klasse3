...
(function () {
  ...
  function buildHTML() {
    ...
    el.innerHTML = [
      ...
      '<strong>Nur anonyme IDs</strong> — die App fragt niemals nach echten Namen. ',
      'Bitte vergeben Sie ausschließlich anonyme Kennungen (z.B. „S-01", „Kind-A").</p></div>',
      '<div class="gd-row"><span class="ri">✅</span><p>',
      ...
      '<ul>',
      '<li><strong>Nur anonyme IDs</strong> – die App speichert niemals echte Namen. ',
      'Eltern und Lehrkräfte vergeben ausschließlich anonyme Kennungen ',
      '(z.B. „S-01", „Kind-A", „Klasse 3a").</li>',
      '<li>Texte und Geschichten des Kindes (im Browser gespeichert)</li>',
      '<li>Selbsteinschätzungen und Checklisten (keine Namen)</li>',
